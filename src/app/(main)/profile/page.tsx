...
export default function ProfilePage() {
  ...
  return (
    <div className="space-y-6 max-w-2xl mx-auto">
      <Card>
        <CardHeader>
          <CardTitle className="text-rainbow-animation">{t('Profile')}</CardTitle>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="grid gap-2">
            ...
            <Input id="email" type="email" defaultValue="sanjay.tailor@perfectfit.com" readOnly />
          </div>
          <div className="grid gap-2">
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-rainbow-animation">{t('Professional Details')}</CardTitle>
      ...
      <Card>
          <CardHeader>
              <CardTitle className="text-rainbow-animation">{t('Portfolio')}</CardTitle>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-rainbow-animation">{t('Change Password')}</CardTitle>
