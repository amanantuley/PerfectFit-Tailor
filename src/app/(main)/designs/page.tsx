    ...
    <div className="flex flex-col gap-6">
      <div className="flex items-center justify-between">
        ...
        <Dialog open={open} onOpenChange={setOpen}>
          ...
          <DialogContent>
            <DialogHeader>
              <DialogTitle className="text-rainbow-animation">{t('Upload New Design')}</DialogTitle>
              <DialogDescription>
                ...
                <Carousel>
                  <CarouselContent>
                    <CarouselItem>
                     ...
                     <CarouselItem>
                      <Image
                        src={design.imageUrl.replace('600x400', '600x401')} // Just to get a different placeholder
                        alt={design.title}
                        width={600}
                        height={400}
                        className="rounded-t-lg object-cover"
                        data-ai-hint="tailored clothing"
                      />
                    </CarouselItem>
                  </CarouselContent>
