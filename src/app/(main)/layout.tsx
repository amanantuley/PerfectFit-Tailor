        ...
        <SidebarHeader>
          ...
          >
            ...
            <h1 className="text-xl font-semibold text-sidebar-foreground">
              <span className="text-rainbow-animation">{t('PerfectFit-Tailors')}</span>
            </h1>
          </motion.div>
        </SidebarHeader>
        <SidebarContent>
      ...
      <SidebarInset>
        <header className="flex h-16 items-center justify-between gap-4 border-b bg-background px-6">
          <div className="flex items-center gap-4">
            ...
            <motion.h2
              ...
              className="text-xl font-semibold text-rainbow-animation">{getPageTitle(pathname)}</motion.h2>
          </div>
          <motion.div
            initial={{ opacity: 0, y: -20 }}
            animate={{ opacity: 1, y: 0 }}
        ...
        <main className="flex-1 overflow-y-auto p-6">
         ...
         <footer className="border-t bg-background p-4 text-center text-sm text-muted-foreground">
            © 2025 {t('PerfectFit-Tailors')}. All Rights Reserved.
        </footer>
        <ChatbotWidget />
      </SidebarInset>
    </SidebarProvider>
